          ...
          child: Column(
            children: [
              TextFormField(
                ...
                onChanged: (value) =>
                    ref.read(profileProvider.notifier).updateUserName(value),
                validator: (value) {
              ...
              TextFormField(
                ...
                onChanged: (value) =>
                    ref.read(profileProvider.notifier).updateAttribute(value),
              ),
              const SizedBox(height: 20),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (state.hasMentalIllness == true) ...[
                    ...
                    ...[
                      ...
                      'その他'
                          ...
                          value: state.mentalIllnesses?.contains(diagnosis) ??
                              false,
                          onChanged: (checked) {
                            final newList =
